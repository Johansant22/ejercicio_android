...
class DataSource() {
    fun getSuperHeroes():MutableList<Superheroe> {
        ...
        superheroes.add(Superheroe("Iron Man", "Marvel", "Tony Stark", "https://cursokotlin.com/wp-content/uploads/2017/07/ironman.jpg"))
        superheroes.add(Superheroe("Superman", "DC", "Clark Kent", "https://cursokotlin.com/wp-content/uploads/2017/07/superman.jpg"))
